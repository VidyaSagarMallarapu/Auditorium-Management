...
public class Manager_Clerk extends HttpServlet {
   ...
   //  Database credentials
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String uid=request.getParameter("Clerk");
	   ...
	   int temp=m.Clerk(username,password,name,uid);
	   try{
	      
           if(temp==1)
          out.println("registered Clerk successfully<br> ");
         else if(temp==2)
